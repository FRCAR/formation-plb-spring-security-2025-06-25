...
INSERT INTO MON_UTILISATEUR (LOGIN, MOT_DE_PASSE) VALUES ('user', '{bcrypt}$2a$10$NL.xWeQJnyZmAx8/InJHa.4LeuOJpNB5gLPUrSLAbHt4RNX/DjJJa'); 
--Encodage BCrypt(10) de admin
INSERT INTO MON_UTILISATEUR (LOGIN, MOT_DE_PASSE) VALUES ('admin', '{noop}admin');
--Encodage BCrypt(10) de webServicePassword
INSERT INTO MON_UTILISATEUR (LOGIN, MOT_DE_PASSE) VALUES ('webservice', '{bcrypt}$2a$10$w0gWeF9BLnhbsCLDjmkTleILSQfXE5jiGL7W0mrzhxSqAGTupopUK');
